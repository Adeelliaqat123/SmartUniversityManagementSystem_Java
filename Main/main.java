...
public class main {
    public static void main(String[] args) {
        // === MODULE 1 & 2 TESTING (from your existing code) ===
        ...
        // Create people
        UndergraduateStudent u1 = new UndergraduateStudent("S1001", "Ali Khan", "ali@uni.edu", "0300-1111111", "BSCS", 2);
        GraduateStudent g1 = new GraduateStudent("S1002", "Sara Ali", "sara@uni.edu", "0300-2222222", "MSCS", "F101");
        PhDStudent p1 = new PhDStudent("S1003", "Zain Malik", "zain@uni.edu", "0300-3333333", "PhD-CS", "Machine Learning");
        ...
        // Show fines for any overdue (simulate late return by re-running later)
